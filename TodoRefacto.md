...
|  3   | Séparer `World::Update` en systèmes                                 |      L      |      5      | `World::Update` gère scripts, transforms, input, caméra et rendu dans une seule fonction.  À terme, il faut `ScriptSystem`, `TransformSystem`, `CameraSystem`, `RenderSubmissionSystem`, etc.                          | `World`                                 | Maintenant / bientôt              | WorkInProgress |
...
|  18  | Aligner CMake / README / standard C++                               |      S      |      4      | Le root demande CMake 3.28, `Engine` demande CMake 4.0.  Ce genre d’incohérence doit disparaître.                                                                                                                      | CMake / docs                            | Maintenant                        |      Todo      |
